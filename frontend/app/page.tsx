                  ...
                  {[
                    {
                      ...
                      label: "Fit Analysis",
                        ...
                        progressMessage?.includes("Fit analysis complete") ||
                        progressMessage?.includes("Optimizing") ||
                        progressMessage?.includes("Resume") ||
                        progressMessage?.includes("Outreach") ||
                        progressMessage?.includes("Cover"),
                    },
                    {
                      key: "resume",
                      label: "Resume Optimization",
                      done: progressMessage?.includes(
                    ...
                    },
                    {
                      ...
                      label: "Outreach Message",
                        ...
                        "Outreach message complete",
                      ),
                    },
                    {
                      key: "cover",
                      label: "Cover Letter",
                      done: progressMessage?.includes("Cover letter complete"),
                    },
                  ].map((task) => (
                    <span
                      key={task.key}
                    ...
                    >
                      <span
                        className={`w-1.5 h-1.5 rounded-full ${task.done ? "bg-green-500" : "bg-amber-500 animate-pulse"}`}
                      />
                      {task.label}
                    </span>
                  ))}
